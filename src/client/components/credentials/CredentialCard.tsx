          ...
          <div className="space-y-2">
            <div className="flex gap-3">
              <input
                ...
                className="flex-1 px-3 py-1.5 text-sm font-mono bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded focus:outline-none focus:ring-2 focus:ring-primary-500 dark:text-white"
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex items-center gap-1 px-3 py-1.5 text-sm bg-primary-500 hover:bg-primary-600 disabled:bg-slate-300 dark:disabled:bg-slate-700 text-white disabled:text-slate-500 rounded transition-colors"
              >
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="p-2 text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded transition-colors"
        ...
        <div className="border-t border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50 px-4 py-3">
          <div className="space-y-2">
            {matchedDevices.map((device) => (
              ...
              >
                <Router className="w-3.5 h-3.5 text-primary-500" />
