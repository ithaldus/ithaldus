...
import type { NetworksProps, Network } from '@/../product/sections/networks/types'
...
export function Networks({
  ...
  const handleAdd = (name: string, rootIp: string, rootUsername: string, rootPassword: string) => {
    onAdd?.(name, rootIp, rootUsername, rootPassword)
    setShowAddModal(false)
  }

  const handleEdit = (name: string, rootIp: string, rootUsername: string, rootPassword: string) => {
    if (editingNetwork) {
      onEdit?.(editingNetwork.id, name, rootIp, rootUsername, rootPassword)
