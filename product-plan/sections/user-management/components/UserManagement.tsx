...
import type { UserManagementProps, User, UserRole } from '@/../product/sections/user-management/types'
...
export function UserManagement({
  ...
  const handleAdd = (email: string, name: string, role: UserRole) => {
    onAdd?.(email, name, role)
    setShowAddModal(false)
  }

  const handleEdit = (email: string, name: string, role: UserRole) => {
    if (editingUser) {
      onEdit?.(editingUser.id, name, role)
      setEditingUser(null)
    }
  }
