...
- **SECTION_NAME** = [Human-readable name, e.g., "Topology Discovery" or "User Management"]
- **SECTION_ID** = [Folder name in sections/, e.g., "topology-discovery" or "user-management"]
